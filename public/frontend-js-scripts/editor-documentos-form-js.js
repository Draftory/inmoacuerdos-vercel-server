...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (botonFinalizar) {
    botonFinalizar.addEventListener("click", function () {
      ...
      const MemberstackID = MemberstackIDInput ? MemberstackIDInput.value : ""; // Obtén el valor si el elemento existe, sino una cadena vacía
...
document
  ...
  .addEventListener("click", (event) => saveContractVersion(event, "Borrador"));

// Event listener for the original save final button
document
  .querySelector(".save-as-final-btn")
  .addEventListener("click", (event) => saveContractVersion(event, "Contrato"));
